...
import AbstractCanvas from "./AbstractCanvas";
  ...
  Promise.all([
    import("../operations/ot/NodeAddOperation"),
    import("../operations/ot/NodeDeleteOperation"),
    import("../operations/ot/EdgeAddOperation"),
    import("../operations/ot/EdgeDeleteOperation"),
    import("../operations/non_ot/ToolSelectOperation"),
    import("../operations/non_ot/EntitySelectOperation"),
    import("../operations/non_ot/ActivityOperation"),
    import("../operations/non_ot/ExportMetaModelOperation"),
    import("../operations/non_ot/ExportLogicalGuidanceRepresentationOperation"),
    import("../operations/non_ot/ExportImageOperation"),
    import("../operations/non_ot/ShowGuidanceBoxOperation"),
    import("../operations/non_ot/CanvasViewChangeOperation"),
    import("../operations/non_ot/RevokeSharedActivityOperation"),
    import("../operations/non_ot/MoveCanvasOperation"),
    import("../operations/non_ot/GuidanceStrategyOperation"),
    import("../canvas_widget/AbstractEntity"),
    import("../canvas_widget/ModelAttributesNode"),
    import("../canvas_widget/EntityManager"),
    import("../canvas_widget/HistoryManager"),

    import("../canvas_widget/MoveTool"),
    import("../canvas_widget/guidance_modeling/GuidanceBox"),
    import("../canvas_widget/guidance_modeling/SelectToolGuidance"),
    import("../canvas_widget/guidance_modeling/SetPropertyGuidance"),
    ...
    ActivityOperation,
    ExportMetaModelOperation,
    ExportLogicalGuidanceRepresentationOperation,
    ExportImageOperation,
    ShowGuidanceBoxOperation,
    CanvasViewChangeOperation,
    RevokeSharedActivityOperation,
    MoveCanvasOperation,
    GuidanceStrategyOperation,
    AbstractEntity,
    ModelAttributesNode,
    EntityManager,
    HistoryManager,
    ...
    class Canvas extends AbstractCanvas {
      constructor($node) {
            ...
            if (
              ...
              if (operation.getDefaultLabel()) {
                node
                  .getLabel()
                  .getValue()
                  .setValue(operation.getDefaultLabel());
              }
        ...
        var localExportLogicalGuidanceRepresentationCallback = function (
          ...
          if (
            operation instanceof ExportLogicalGuidanceRepresentationOperation
          ) {
            if (operation.getData() === null) {
              operation.setData(
                    ...
                    hide: {
                      ...
                      items: {
                        nodes: {
                          name: "nodes..",
                          items:
                            EntityManager.generateVisibilityNodeMenu("hide"),
                        },
                        edges: {
                          name: "edges..",
                          items:
                            EntityManager.generateVisibilityEdgeMenu("hide"),
                        },
                      },
                    },
                    show: {
                      ...
                      items: {
                        nodes: {
                          name: "nodes..",
                          items:
                            EntityManager.generateVisibilityNodeMenu("show"),
                        },
                        edges: {
                          name: "edges..",
                          items:
                            EntityManager.generateVisibilityEdgeMenu("show"),
                        },
                      },
                    },
                  },
        ...
        this.createNode = function (
          ...
          if (
            ...
            oType =
              EntityManager.getViewNodeType(type).getTargetNodeType().TYPE;
          }
        ...
        this.createEdge = function (
          ...
          if (
            ...
            oType =
              EntityManager.getViewEdgeType(type).getTargetEdgeType().TYPE;
          }
          ...
          $.when.apply($, promises).then(function () {
            ...
            for (nodeId in nodes) {
              if (nodes.hasOwnProperty(nodeId)) {
                ...
                maxRight = Math.max(
                  maxRight,
                  appearance.left + appearance.width
                );
                maxBottom = Math.max(
                  maxBottom,
                  appearance.top + appearance.height
                );
              }
            }
        ...
        var convertNodeTreeToCanvas = function ($node, ctx) {
          ...
          function convertNodeToSVG($node) {
            ...
            if (
              contents.length === 1 &&
              contents[0].nodeType === Node.TEXT_NODE
            ) {
              value = $node.text();
            } else {
              value = $node.val();
          ...
          canvasMap.observe(function (event) {
            ...
            if (yUserId !== y.clientID || event.value.historyFlag) {
              ...
              switch (event.name) {
                ...
                case "triggerSave": {
                  if (
                    event.value === _iwcw.getUser()[CONFIG.NS.PERSON.JABBERID]
                  )
                    $("#save").click();
                  break;
                }
