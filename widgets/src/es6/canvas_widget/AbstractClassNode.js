                    ...
                    items: {
                        objectNode: {
                            ...
                            callback: function(){
                                ...
                                nodeId = canvas.createNode($__canvas_widget_ObjectNode.TYPE,appearance.left,appearance.top,appearance.width,appearance.height,that.getZIndex(),that.getContainment(),that.toJSON());
                        ...
                        relationshipNode: {
                            ...
                            callback: function(){
                                ...
                                //noinspection JSAccessibilityCheck
                                nodeId = canvas.createNode($__canvas_widget_RelationshipNode.TYPE,appearance.left,appearance.top,appearance.width,appearance.height,that.getZIndex(),that.getContainment(),that.toJSON());
                                var edges = that.getOutgoingEdges(),
                                    edge,
                                    edgeId;
                        ...
                        relationshipGroupNode: {
                            ...
                            callback: function(){
                                ...
                                //noinspection JSAccessibilityCheck
                                nodeId = canvas.createNode($__canvas_widget_RelationshipGroupNode.TYPE,appearance.left,appearance.top,appearance.width,appearance.height,that.getZIndex(),that.getContainment(),that.toJSON());
                                var edges = that.getOutgoingEdges(),
                                    edge,
                                    edgeId;
