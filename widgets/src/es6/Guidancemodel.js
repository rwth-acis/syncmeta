import $ from 'jqueryui';
    ...
    function Guidancemodel() {
        ...
        var activityName = $('.activityEntry.activitySel', parent.document).find('.activity-title').text();

        console.info('Guidance promise by ' + frameElement.name + ' Activity:' + activityName);
