require([
  ...
  "ildeApi",
  "lodash",
], function ($, _, Util, MFExport, JSZip, ILDE, _) {
                    ...
                    switch (rolePart.type) {
                      case "Role Part":
                        ...
                        for (involvedActivityId in involvedActivities) {
                          if (
                            involvedActivities.hasOwnProperty(
                              involvedActivityId
                            )
                          ) {
                            involvedActivity =
      ...
      if (ilde == null) {
        ...
        $("#ilde_login_form").submit(function (event) {
          ...
          ilde.onLoginFail(function () {
            sayError(
              "Please check your login credentils and installation URL!"
            );
            ilde = null;
          });
