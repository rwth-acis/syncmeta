define([
    ...
    function AbstractNode(id,type,left,top,width,height,zIndex, origin){
                ...
                build: function($trigger, e){
					...
					if(_canvas.getSelectedEntity() === null || _canvas.getSelectedEntity() === that){
                        menuItems = _.extend(_contextMenuItemCallback(),{
                            ...
                            addNode: {
                                name: "Add node..",
                                items: require('viewcanvas_widget/EntityManager').generateAddNodeMenu(that.getCanvas(), e.originalEvent.offsetX+offsetClick.left-offsetCanvas.left, e.originalEvent.offsetY+offsetClick.top-offsetCanvas.top)
                            },
                            copy:{
                                name:'Copy',
                                callback:function(){
        ...
        this.select = function(){
            ...
            Util.delay(100).then(function(){_.each(require('viewcanvas_widget/EntityManager').getEdges(),function(e){e.setZIndex();});});
        };
