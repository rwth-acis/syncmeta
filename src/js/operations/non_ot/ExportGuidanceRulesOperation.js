define([
    ...
    ExportGuidanceRulesOperation.TYPE = "ExportGuidanceRulesOperation";

    /**
     * Export Image Operation
     * @class operations.non_ot.ExportGuidanceRulesOperation
     * @memberof operations.non_ot
     * @constructor
     * @param {string} requestingComponent Name of requesting Component
     * @param {string} data Meta model
     */
    function ExportGuidanceRulesOperation(requestingComponent,data){
        /**
        ...
        this.toNonOTOperation = function(){
            if(_nonOTOperation === null){
                _nonOTOperation = new NonOTOperation(
                    ExportGuidanceRulesOperation.TYPE,
                    JSON.stringify({
    ...
    return ExportGuidanceRulesOperation;
