...
requirejs([
    ...
    //'promise!Space'
],function ($, _, require, IWCW, yjsSync,Util, NodePreview, NodeAddOperation,NodeMoveOperation,NodeResizeOperation,NodeDeleteOperation, CanvasViewChangeOperation/*, model, guidancemodel,space*/) {
