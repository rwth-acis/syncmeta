...
export let WidgetContainer: {
    new (): {
        ...
        _$El: any;
        u(): void;
        _$E_: Promise<any> | Promise<boolean>;
        ...
        _$AE(t: any): void;
        _$Ek(): void;
        readonly updateComplete: Promise<any> | Promise<boolean>;
        getUpdateComplete(): Promise<any> | Promise<boolean>;
    ...
    getPropertyDescriptor(t: any, i: any, s: any): {
        get(): any;
        set(e: any): void;
    ...
    _$Ev: Map<any, any>;
    elementStyles: any[];
    finalizeStyles(i: any): any[];
    _$Ep(t: any, i: any): string;
    shadowRootOptions: {
        mode: string;
    };
};
