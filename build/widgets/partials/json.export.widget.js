...
var MFExport = {
  getJSON: function (callback) {
    var cb = function (operation) {
      if (
        operation instanceof ExportDataOperation &&
  ...
  getImageURL: function (callback) {
    var cb = function (operation) {
      if (
        operation instanceof ExportImageOperation &&
        typeof callback === "function"
      ) {
        callback(operation.getData(), space.title);
        iwc.unregisterOnDataReceivedCallback(cb);
...
let JSONExportWidget = class JSONExportWidget extends SyncMetaWidget(LitElement, getWidgetTagName(CONFIG.WIDGET.NAME.JSON_EXPORT)) {
...
JSONExportWidget.styles = css `
  ...
  `;
JSONExportWidget = __decorate([
    e(getWidgetTagName(CONFIG.WIDGET.NAME.JSON_EXPORT))
], JSONExportWidget);

export { JSONExportWidget };
//# sourceMappingURL=json.export.widget.js.map
