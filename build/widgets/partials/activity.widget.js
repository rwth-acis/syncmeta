  ...
  constructor($userListNode, $activityListNode) {
    ...
    this.addUser = function (jabberId, isLocalUser = false) {
      ...
      if (!userList.hasOwnProperty(jabberId)) {
        const userListContainsLocalUser = lodash.some(
          userList,
          (u) => u.isLocalUser
        );
      ...
      selectionMap.observe(function (event) {
        event.keysChanged.forEach((key) => {
          ...
          if (value === null) {
            ...
            lodash.each(
              lodash.filter(activityList, function (activity) {
    ...
    firstUpdated(_changedProperties) {
        ...
        yjsSync()
            ...
            WaitForCanvas(CONFIG.WIDGET.NAME.ACTIVITY, y)
                ...
                WidgetTracker$1.init(user[CONFIG.NS.PERSON.JABBERID], $node);
...
ActivityWidget = __decorate([
    e(getWidgetTagName(CONFIG.WIDGET.NAME.ACTIVITY))
], ActivityWidget);

export { ActivityWidget };
//# sourceMappingURL=activity.widget.js.map
