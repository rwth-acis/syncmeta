...
class AbstractTool {
  ...
  constructor(
    ...
    if (type == "svg") {
      _$node = $(
        lodash.template(abstractToolHtml)({
          icon: toolIcon,
          label: _label,
          color: _color,
          type,
...
class GeneralisationEdgeTool extends AbstractTool {
  constructor(
    ...
    toolLabel = null,
    toolDescription = null,
    toolIcon = `<svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="currentColor" class="bi bi-arrow-up" viewBox="0 0 16 16"><path fill-rule="evenodd" d="M8 15a.5.5 0 0 0 .5-.5V2.707l3.146 3.147a.5.5 0 0 0 .708-.708l-4-4a.5.5 0 0 0-.708 0l-4 4a.5.5 0 1 0 .708.708L7.5 2.707V14.5a.5.5 0 0 0 .5.5z"/></svg>`,
    type = "svg"
  ) {
    super(
...
let PaletteWidget = class PaletteWidget extends SyncMetaWidget(LitElement, getWidgetTagName(CONFIG.WIDGET.NAME.PALETTE)) {
    constructor() {
        super(...arguments);
        this.widgetName = getWidgetTagName(CONFIG.WIDGET.NAME.PALETTE);
    }
...
PaletteWidget = __decorate([
    e(getWidgetTagName(CONFIG.WIDGET.NAME.PALETTE))
], PaletteWidget);

export { PaletteWidget };
//# sourceMappingURL=palette.widget.js.map
